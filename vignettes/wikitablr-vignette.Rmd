...
If we want to work with one table individually, we can extract it and then apply `empty_to_na()`. For example, if we want to clean the names of the 11th table on the Bob's Burgers page, it will look like this.
